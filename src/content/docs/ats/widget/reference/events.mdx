...
**Step order and progress (register and update share the same sequence):**

| Step | Progress | Description |
|------|----------|-------------|
| `validating` | 5% | Validating work data |
| `preparing_transaction` | 20% | Preparing transaction |
| `signing` | 40% | Signing transaction |
| `submitting` | 60% | Submitting to blockchain |
| `confirming` | 80% | Waiting for confirmation |
| `completed` | 100% | Done |
